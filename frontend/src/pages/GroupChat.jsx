...
const GroupChat = () => {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      try {
        const { data } = await axios.get("/api/group/get-messages", {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      const { data } = await axios.post("/api/group/send-message", { groupId: activeGroup._id, message: msg }, {
  ...
  const handleAddExpense = async (e) => {
    ...
    try {
      const { data } = await axios.post("/api/group/add-expense", {
